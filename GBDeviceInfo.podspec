Pod::Spec.new do |s|
  ...
  s.source                    = { :git => 'https://github.com/amardon/GBDeviceInfo.git', :tag => s.version.to_s }
  ...
  s.ios.public_header_files   = 'GBDeviceInfo/*_iOS.h', 'GBDeviceInfo/*_Common.h', 'GBDeviceInfo/GBDeviceInfo.h', 'GBDeviceInfo/GBDeviceInfoInterface.h', 'GBDeviceInfo/GBDeviceInfo_Subclass.h, 'UCKReachability.h'
